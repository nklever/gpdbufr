...
setuptools.setup(
    name="gpdbufr",
    version=parse_version_from("gpdbufr/__init__.py"),
    description="GeoPandas reader for the BUFR format using ecCodes.",
    long_description=read("README.rst"),
    #author="European Centre for Medium-Range Weather Forecasts (ECMWF)",
    #author_email="software.support@ecmwf.int",
    license="Apache License Version 2.0",
    #url="https://github.com/ecmwf/pdbufr",
    url="https://github.com/nklever/gpdbufr",
    packages=setuptools.find_packages(),
    include_package_data=True,
    install_requires=["attrs", "eccodes", "pandas","pdbufr","geopandas","shapely"],
    extras_require={"tests": ["flake8", "pytest", "pytest-cov"]},
    zip_safe=True,
    keywords="eccodes bufr geopandas",
    classifiers=[
